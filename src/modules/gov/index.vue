...
<template>
    <div>
        <div class="tabs mb-4 text-center">
            <a class="tab tab-bordered" :class="{ 'tab-active': tab === '2'}" @click="changeTab('2')">{{ $t('gov.voting') }}</a>
            <a class="tab tab-bordered" :class="{ 'tab-active': tab === '3'}" @click="changeTab('3')">{{ $t('gov.passed') }}</a>
            <a class="tab tab-bordered" :class="{ 'tab-active': tab === '4'}" @click="changeTab('4')">{{ $t('gov.rejected') }}</a>
        </div>
